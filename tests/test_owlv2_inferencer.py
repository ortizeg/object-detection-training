"""Tests for OWLv2 inferencer with mocked transformers model."""
...
def _mock_transformers():
    ...
    with (
        patch(
            "object_detection_training.inference.owlv2_inferencer.Owlv2Processor"
        ) as mock_proc_cls,
        patch(
            "object_detection_training.inference.owlv2_inferencer"
            ".Owlv2ForObjectDetection"
        ) as mock_model_cls,
        patch(
            "object_detection_training.inference.owlv2_inferencer.torch"
        ) as mock_torch,
    ):
