...
from object_detection_training.models.rfdetr.backbone.base import BackboneBase
from object_detection_training.models.rfdetr.backbone.dinov2 import DinoV2
from object_detection_training.models.rfdetr.backbone.projector import (
    MultiScaleProjector,
)
...
class Backbone(BackboneBase):
    ...
    def __init__(
        ...
        patch_size: int = 14,
        num_windows: int = 4,
        positional_encoding_size: Union[int, bool] = False,
    ):
        super().__init__()
