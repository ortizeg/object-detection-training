...
from object_detection_training.models.rfdetr.backbone import build_backbone
from object_detection_training.models.rfdetr.matcher import build_matcher
from object_detection_training.models.rfdetr.segmentation_head import (
    SegmentationHead,
    get_uncertain_point_coords_with_randomness,
    point_sample,
)
from object_detection_training.models.rfdetr.transformer import build_transformer
from object_detection_training.models.rfdetr.util import box_ops
...
@register(group="model", name="lw_detr")
...
@register(group="criterion", name="rfdetr_criterion")
...
@register(group="postprocessor", name="rfdetr_postprocessor")
