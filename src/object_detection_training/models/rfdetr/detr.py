...
from object_detection_training.models.rfdetr.main import (
    Model,
    download_pretrain_weights,
)
from object_detection_training.models.rfdetr.util.coco_classes import COCO_CLASSES
from object_detection_training.models.rfdetr.util.metrics import (
    MetricsPlotSink,
...
class RFDETR:
    ...
    def export(self, **kwargs):
        ...
        See [the ONNX export documentation](https://object_detection_training.models.rfdetr.roboflow.com/learn/train/#onnx-export) for more information.
        """
    ...
    def train_from_config(self, config: TrainConfig, **kwargs):
        ...
        if config.early_stopping:
            from object_detection_training.models.rfdetr.util.early_stopping import (
    ...
    def deploy_to_roboflow(
        ...
        Args:
            ...
            size (str, optional): The size of the model to deploy. If not provided,
                it will default to the size of the model being trained (e.g., "object_detection_training.models.rfdetr-base", "object_detection_training.models.rfdetr-large", etc.).
...
class RFDETRBase(RFDETR):
    ...
    size = "object_detection_training.models.rfdetr-base"
...
class RFDETRLarge(RFDETR):
    ...
    size = "object_detection_training.models.rfdetr-large"
...
class RFDETRNano(RFDETR):
    ...
    size = "object_detection_training.models.rfdetr-nano"
...
class RFDETRSmall(RFDETR):
    ...
    size = "object_detection_training.models.rfdetr-small"
...
class RFDETRMedium(RFDETR):
    ...
    size = "object_detection_training.models.rfdetr-medium"
...
class RFDETRSegPreview(RFDETR):
    size = "object_detection_training.models.rfdetr-seg-preview"
